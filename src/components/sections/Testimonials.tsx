  ...
  return (
    <section className="relative py-24 md:py-28">
      <div className="container-x relative">
        ...
        {/* Photo height follows each upload's natural aspect ratio */}
        <div className="mt-16 grid grid-cols-1 gap-y-12 sm:mt-20 md:mt-20 md:grid-cols-3 md:gap-8">
          {items.map((it, i) => (
            <RevealOnScroll key={i} index={i}>
              <figure className="gold-glow-card relative flex h-full flex-col items-center rounded-3xl p-8 text-center">
                <div className="relative -mt-20 mb-2 w-full sm:-mt-24">
                  <div className="relative">
                    ...
                    <EditableImage
                      ...
                      alt={it.author}
                      autoHeight
                      className="relative w-full ring-2 ring-gold-primary/40"
